...
class LayananController extends Controller
{
    public function index()
    {
        ...
        return view('main.user.layanan.index', [
            "layanans" => $layanans,
    ...
    {
        return view('main.user.layanan.create', [
            'title' => 'Tambah Data',
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($layanan->save()) {
            ...
            return redirect()->route('user.layanan.index')->with('pesan', 'Data berhasil disimpan.');
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('main.user.layanan.edit', [
            'layanan' => $layanan,
            'title' => 'Laman Edit'
        ]);
    }
    public function update(Request $request, $id)
    {
        ...
        // Redirect ke halaman layanan dengan pesan sukses
        return redirect()->route('user.layanan.index')->with('pesan', 'Data berhasil diubah.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.layanan.index')->with('pesan', 'Kategori berhasil dihapus.');
    }
}
